    ...
    >
      ...
      {stack.map((el, idx) => (
        <div
          ...
          className={`skew-x-6 shadow-xl absolute grid w-16 h-12 border-b-2 rounded border-base-100 text-primary-content place-content-center bg-primary cursor-pointer hover:translate-y-6 hover:translate-x-2 hover:skew-x-12 transition-all hover:bg-primary-focus `}
        >
