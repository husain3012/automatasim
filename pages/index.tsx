...
const IndexPage = () => (
  <Layout title="Automata">
    ...
    <div
      id="how_to_use"
      className="p-4 sm:p-16 phone-1 flex flex-col sm:flex-row justify-center items-center w-3/4 m-auto"
    >
      <h1 className="text-5xl font-bold text-center sm:text-left m-4 ">
        How to use?
      </h1>

      <iframe
        className="w-4/5 sm:w-full sm:h-96 m-4"
        src="https://www.youtube.com/embed/0BhxUC31pqs"
